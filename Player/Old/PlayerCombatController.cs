...
public class PlayerCombatController : MonoBehaviour
{
    ...
    {
        Collider2D[] deletedObjects = Physics2D.OverlapCircleAll(attack1HitBoxPos.position, attack1Radius, whatIsDamageable);
